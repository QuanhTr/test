...
<!-- Code Html -->
    <!-- Navbar -->
        <div id="navbar-main" class="container-fluid" >
            ...
            <ul class="navbar-main-list">
                <a class="text-decoration-none" href="https://help.shopee.vn/vn/s"><h5 class="pt-4" style="color: #ee4d2d;">Bạn cần giúp đỡ?</h5></a>
            </ul>
        </div>
    <!-- Content -->
                ...
                <div id="content-2" class="col md-6">
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                ...
                                <a class="ms-2 text-decoration-none" href="../Register/register.php"><p style="color:#ee4d2d">Đăng ký</p></a>
                            </div>
                        </div>
                </div>
            </div>
